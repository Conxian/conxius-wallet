...
class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  render(): ReactNode {
    if (this.state.hasError) {
      ...
      return (
        <div className="bg-white border border-red-500/30 rounded-3xl p-8 m-4 space-y-6 max-w-lg mx-auto">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 rounded-2xl bg-red-500/10 flex items-center justify-center shrink-0">
              <AlertTriangle className="text-red-500" size={24} />
            </div>
            <div>
              <h3 className="text-lg font-bold text-brand-deep">{scope} Error</h3>
          ...
          {this.state.error && (
            <div className="bg-off-white/50 border border-border rounded-2xl p-4 space-y-2">
              <div className="flex items-center gap-2">
                <Bug size={14} className="text-brand-earth" />
                <p className="text-[10px] font-bold text-brand-earth uppercase tracking-widest">Error Details</p>
              </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <p className="text-[10px] text-brand-earth">
          ...
          <button
            ...
            className="w-full py-4 bg-off-white hover:bg-border text-brand-deep font-black rounded-2xl text-xs uppercase tracking-widest flex items-center justify-center gap-3 transition-all border border-border"
          >
            <RotateCcw size={16} />
            Retry {scope}
          </button>
