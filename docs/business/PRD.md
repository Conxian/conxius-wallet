...
| **Ark / StateChain** | PARTIAL / RESEARCH | StateChain native path; Ark contract exists, but mobile V-UTXO derivation, lift, forfeit, and redemption paths remain fail-closed pending reviewed backend integration |
