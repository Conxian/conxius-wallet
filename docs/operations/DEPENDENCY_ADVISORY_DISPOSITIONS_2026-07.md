...
expires **2026-10-19**. No expiry extension, owner change, approval, or
...
- **Expiry/recheck:** Hard expiry **2026-10-19**; recheck upstream availability
...
- **Recheck:** Recheck `vite-plugin-top-level-await`, Vite, and esbuild
  compatibility by **2026-10-19**, or earlier if a published fixed release is
  available.
...
- **Fix state:** Fixed with exact workspace override `@babel/core: 7.29.7`, a
...
- **Recheck:** Recheck published releases, compatible Wormhole/CosmJS updates,
  and parent-path isolation by **2026-10-19**.
...
default policy with two pending exceptions expiring 2026-10-19; release mode
