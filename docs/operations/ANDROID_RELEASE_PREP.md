...
| Compile SDK | `36` | `android/app/build.gradle.kts`, Android library module `build.gradle.kts` files, and `android/variables.gradle` |
| Target SDK | `35` | `android/app/build.gradle.kts` and `android/variables.gradle` |
| Minimum SDK | `26` | `android/app/build.gradle.kts`, Android library module `build.gradle.kts` files, and `android/variables.gradle` |
