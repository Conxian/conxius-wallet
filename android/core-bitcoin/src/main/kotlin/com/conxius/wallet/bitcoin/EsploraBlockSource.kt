...
object EsploraTransactionParser {
    ...
    private const val MAX_SCRIPTSIG_BYTES = 1_650
    private const val MAX_SCRIPTSIG_PUSH_BYTES = 1_650
    private const val MAX_SCRIPT_BYTES = 10_000
    private const val MAX_WITNESS_ITEM_BYTES = 4_129
    private const val MAX_TAPROOT_CONTROL_BLOCK_BYTES = 4_129
    private val RIPEMD_R_LEFT = intArrayOf(
    ...
    private val RIPEMD_R_RIGHT = intArrayOf(
    ...
    private val RIPEMD_S_LEFT = intArrayOf(
    ...
    private val RIPEMD_S_RIGHT = intArrayOf(
    ...
    private val RIPEMD_K_LEFT = intArrayOf(
            0x00000000,
            0x5a827999,
            0x6ed9eba1,
            0x8f1bbcdc.toInt(),
    ...
    private val RIPEMD_K_RIGHT = intArrayOf(
            0x50a28be6.toInt(),
            0x5c4dd124.toInt(),
            0x6d703ef3.toInt(),
            0x7a6d76e9.toInt(),
    ...
    private val NUMS_INTERNAL_KEY_X: ByteArray =
